...
$lang = array_merge($lang, array(
	...
	<br /><br />
	<strong>Organización del Grupo</strong>
	<br />
	&mdash; Cualquiera puede solicitar la pertenencia al Grupo, así como la asistencia a alguna de nuestras salidas.<br />
	&mdash;	En cualquier momento se puede declinar la pertenencia al Grupo.<br />
	&mdash; Solo se podrá excluir del Grupo a quién no observe estas normas. La expresión de contenidos ofensivos o que atenten a la dignidad de las personas supondrá la exclusión inmediata.<br />
	&mdash; La pertenencia al Grupo no comporta ningún coste. <br />
	&mdash; El Grupo se establece entre iguales. Los administradores y moderadores ejercerán las tareas de supervisión de las comunicaciones y observación de las normas establecidas dentro del mismo, así como las publicaciones de carácter general. Nadie se puede atribuir la propiedad del Grupo.<br />
	&mdash; El funcionamiento y organización serán democráticos. La administración será consensuada entre los administradores.<br />
	&mdash; La organización de las salidas será de manera totalmente desinteresada.<br />
	&mdash; Quién sea propietario de una o varias embarcaciones en lista sexta no está excluido del Grupo. Deberá hacer pública su situación, poner sus embarcaciones a disposición del Grupo que las valorará como al resto de empresas de charter Las embarcaciones serán ofertadas sin patrón.<br />
	&mdash; Se establece la realización de una reunión mensual de libre asistencia. Se hará pública la convocatoria a través del foro<br />
	&mdash; Todos tenemos derecho a proponer salidas en cuanto a fechas, destinos, duración, empresas de charter, elección de barcos, coste, etc. Igualmente todos tenemos derecho a solicitar participar en una salida.<br />
	<br /><br />
	<strong>Organización de las salidas</strong>
	<br />	
	&mdash; Cuando se proponga una salida, los interesados solicitarán participar en la misma a través del foro. Cualquiera de los miembros puede incluir un acompañante, para el caso de más acompañantes deberán registrarse en la Web y darse de alta como el resto de personas del grupo. <br />
	&mdash; Cuando haya suficientes personas interesadas, incluidos patrones, se buscará barco, se reservará, se calculará el coste aproximado por navegante.<br />
	&mdash; Para estar inscrito en la salida, es condición imprescindible haber hecho el ingreso del importe establecido. En el caso de haber más personas inscritas que plazas en los barcos, se participará en la salida por orden de inscripción publicado en foro.<br />
	&mdash; Cuando alguien no pueda asistir a una salida por motivos propios, la devolución del dinero ingresado para la salida quedará supeditado a cubrir su plaza por otro navegante. Y en cualquier caso, a la decisión del resto de la tripulación.<br />
	&mdash; En el caso que se suspenda una salida por causas meteorológicas, se devolverá el dinero de las inscripciones, descontando en su caso las cantidades que retengan las empresas de charter, así como el posible gasto en pertrechos que se haya realizado, los cuales se repartirán a partes iguales.<br />
	&mdash; Aunque la salida se programe sobre un plan de navegación previo, la realización del mismo se decidirá entre los integrantes de la salida a la vista de las posibles dificultades meteorológicas.<br />
	&mdash; Si en la salida participa mas de un barco, la derrota, lugares de fondeo y atraque serán consensuados por los patrones manteniendo la unidad del grupo, y se navegará a distancia de cobertura de la emisora de los barcos, salvo que las circunstancias meteorológicas lo impidan o sea acordado por los integrantes de la salida.<br />
	&mdash; Los daños que se produzcan tanto en la embarcación como en su equipamiento y que comporten el pago o retención de una parte de la fianza por la empresa de charter, serán abonados solidariamente por los integrantes del barco afectado. <br />
	&mdash; Todos nos comprometemos a mantener una actitud responsable en las salidas que organizamos.<br />
	<br />
	',
