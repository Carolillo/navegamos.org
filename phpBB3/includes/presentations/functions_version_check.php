...
* @version $Id: functions_version_check.php 3 2010-09-29 01:56:49Z jakk $
...
function mod_version_check($return_version = false)
{
	...
	if (!class_exists('presentations_check_version'))
	{
		include($phpbb_admin_path . 'mods/presentations_check_version.' . $phpEx);
	}
	$class_name = 'presentations_check_version';
